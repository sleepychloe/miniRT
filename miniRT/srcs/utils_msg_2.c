...
/*   Updated: 2022/11/15 04:53:53 by yhwang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_1(t_scene *scene, int flag)
{
	...
	printf("            ║   ║              ║");
	if (flag == 11)
		printf("            ║ x ║ %s%f%s\t║", R, scene->plane[0]->xyz_pos.x, B);
	else
		printf("            ║ x ║ %f\t║", scene->plane[0]->xyz_pos.x);
	if (flag == 15)
		printf("            ║ x ║ %s%f%s\t║\n",
			R, scene->cylinder[0]->xyz_pos.x, B);
	else
...
{
	if (flag == 12)
		printf(" position   ║ y ║ %s%f%s\t║", R, scene->plane[0]->xyz_pos.y, B);
	else
		printf(" position   ║ y ║ %f\t║", scene->plane[0]->xyz_pos.y);
	if (flag == 16)
		printf(" position   ║ y ║ %s%f%s\t║\n",
			R, scene->cylinder[0]->xyz_pos.y, B);
	else
	...
	if (flag == 8)
		printf("            ║ x ║ %s%f%s\t║", R, scene->sphere[0]->xyz_pos.x, B);
	else
		printf("            ║ x ║ %f\t║", scene->sphere[0]->xyz_pos.x);
	if (flag == 13)
		printf("            ║ z ║ %s%f%s\t║", R, scene->plane[0]->xyz_pos.z, B);
	else
...
void	print_3(t_scene *scene, int flag)
{
	if (flag == 17)
		printf("            ║ z ║ %s%f%s\t║\n",
			R, scene->cylinder[0]->xyz_pos.z, B);
	else
	...
	if (flag == 9)
		printf(" position   ║ y ║ %s%f%s\t╠", R, scene->sphere[0]->xyz_pos.y, B);
	else
...
{
	if (flag == 10)
		printf("            ║ z ║ %s%f%s\t║", R, scene->sphere[0]->xyz_pos.z, B);
	else
		printf("            ║ z ║ %f\t║", scene->sphere[0]->xyz_pos.z);
	if (flag == 14)
		printf("            ║ x ║ %s%f%s\t║", R, scene->plane[0]->xyz_vec.x, B);
	else
		printf("            ║ x ║ %f\t║", scene->plane[0]->xyz_vec.x);
	if (flag == 18)
		printf("            ║ x ║ %s%f%s\t║\n",
			R, scene->cylinder[0]->xyz_vec.x, B);
	else
	...
	printf("            ║   ║              ║");
	if (flag == 14)
		printf(" normal vec ║ y ║ %s%f%s\t║", R, scene->plane[0]->xyz_vec.y, B);
	else
...
void	print_5(t_scene *scene, int flag)
{
	if (flag == 18)
		printf(" normal vec ║ y ║ %s%f%s\t║\n",
			R, scene->cylinder[0]->xyz_vec.y, B);
	else
	...
	printf("            ║   ║              ║");
	if (flag == 14)
		printf("            ║ z ║ %s%f%s\t║", R, scene->plane[0]->xyz_vec.z, B);
	else
		printf("            ║ z ║ %f\t║", scene->plane[0]->xyz_vec.z);
	if (flag == 18)
		printf("            ║ z ║ %s%f%s\t║\n",
			R, scene->cylinder[0]->xyz_vec.z, B);
	else

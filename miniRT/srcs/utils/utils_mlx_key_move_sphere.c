...
/*   Updated: 2022/11/16 00:34:58 by yhwang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mlx_move_sphere_x(int key, t_data *data, int i)
{
	...
	if (key == KEY_Z)
		data->scene->sphere[i]->xyz_pos
			= vec3_add_vec3(data->scene->sphere[i]->xyz_pos, vec3(-0.5, 0, 0));
	if (key == KEY_X)
		data->scene->sphere[i]->xyz_pos
			= vec3_add_vec3(data->scene->sphere[i]->xyz_pos, vec3(0.5, 0, 0));
	flag = 8;
...
void	mlx_move_sphere_y(int key, t_data *data, int i)
{
	...
	if (key == KEY_C)
		data->scene->sphere[i]->xyz_pos
			= vec3_add_vec3(data->scene->sphere[i]->xyz_pos, vec3(0, -0.5, 0));
	if (key == KEY_V)
		data->scene->sphere[i]->xyz_pos
			= vec3_add_vec3(data->scene->sphere[i]->xyz_pos, vec3(0, 0.5, 0));
	flag = 9;
...
void	mlx_move_sphere_z(int key, t_data *data, int i)
{
	...
	if (key == KEY_B)
		data->scene->sphere[i]->xyz_pos
			= vec3_add_vec3(data->scene->sphere[i]->xyz_pos, vec3(0, 0, -0.5));
	if (key == KEY_N)
		data->scene->sphere[i]->xyz_pos
			= vec3_add_vec3(data->scene->sphere[i]->xyz_pos, vec3(0, 0, 0.5));
	flag = 10;

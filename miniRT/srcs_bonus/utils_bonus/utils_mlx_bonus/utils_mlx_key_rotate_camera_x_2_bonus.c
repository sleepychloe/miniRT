...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   utils_mlx_key_rotate_camera_x_2_bonus.c            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: yhwang <yhwang@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/28 01:43:59 by yhwang            #+#    #+#             */
/*   Updated: 2022/12/20 09:32:44 by yhwang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
				...
				double val_cos, double val_sin)
{
	...
	while (i < data->scene->n_cone)
	{
		data->scene->cone[i]->xyz_pos
			= vec3(1 * data->scene->cone[i]->xyz_pos.x
				...
				+ -1 * val_sin * data->scene->cone[i]->xyz_pos.z,
				0 * data->scene->cone[i]->xyz_pos.x
				+ val_sin * data->scene->cone[i]->xyz_pos.y
				+ val_cos * data->scene->cone[i]->xyz_pos.z);
		mlx_rotate_camera_x_axis_set_co_vec(data, val_cos, val_sin, i);
		data->scene->cone[i]->xyz_pos
				...
				double val_cos, double val_sin)
{
	...
	while (i < data->scene->n_light)
	{
		data->scene->light[i]->xyz_pos
			= vec3(1 * data->scene->light[i]->xyz_pos.x
				...
				+ -1 * val_sin * data->scene->light[i]->xyz_pos.z,
				0 * data->scene->light[i]->xyz_pos.x
				+ val_sin * data->scene->light[i]->xyz_pos.y
